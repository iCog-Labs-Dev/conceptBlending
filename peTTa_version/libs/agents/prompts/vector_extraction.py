...
- Concept 1: {concept1}
- Concept 2: {concept2}
- Vital Relations: {vital_relations}
...
- Only select properties that can plausibly be connected through the provided vital relations.
- Example: If Concept 1 is "bat" and Concept 2 is "man," and the vital relation is analogy, potential properties include flight, echolocation, nocturnality, intelligence, physical strength, reasoning, symbolism, and iconography.
...
- Represent each concept in the structured format:
 ...
 ((Concept concept1@concept2 (Property (Property1 Degree1) (Property2 Degree2) ... (Property8 Degree8))) (Concept concept2@concept1 (Property (Property1 Degree1) (Property2 Degree2) ... (Property8 Degree8))))
...
- Only include properties that are meaningfully connectable via the given vital relations.
- Assign degrees (0-1) based on how strongly each concept possesses each property.
- Return the structured representation in exactly the specified format.
- Ensure exactly 8 properties are listed for each concept.
- Avoid explanations and backticks.
- Maintain valid MeTTa S-expression format and spacing.
"""
